...
Une deuxième solution est de développer une application de bureau sous Python en utilisant soit le module *tKinter*, soit *PyQt5* pour se charger de l'interface utilisateur. L'avantage est d'avoir un **programme très léger et relativement simple de fonctionnement**. 
